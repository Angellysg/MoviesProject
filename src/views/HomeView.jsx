...
const HomeView = () => {
  return (
    <Box sx={{ width: '90%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', margin: 'auto' }}>
      <Box sx={{ width: '100%' }}> {/* Agregar un margen arriba y abajo */}
        <MoviesCarrousel sx={{ width: '100%', margin: 'auto' }}/>
      </Box>

      <Box sx={{ width: '100%', margin: '20px 0' }}> {/* Agregar un margen arriba y abajo */}
